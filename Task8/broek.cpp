...
/*Broek::Broek(const Broek& original)
    :teller(original.teller),nevner(original.nevner){
}
Broek::Broek(Broek &&original)
    :teller(original.teller),nevner(original.nevner){
    cout<<"Movekonstruktør"<<endl;
}
...
/*Broek::~Broek(){
    if(this!=nullptr){
        //delete this;
        cout << "Destruktør: Plass frigjort"<<endl;
    }
    //cout<< "På vei ut av destruktør."<<endl;
}*/
